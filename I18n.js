...
var catalog = {
  en: {
    ...
    sourceGroupNowcastDetails: "15-minute time axis from the forecast. In the DWD area the rain values come from DWD MOSMIX, and the rain in the next hour and the current intensity (menu bar) from the DWD radar via Bright Sky.",
    ...
    sourceGroupWindDetails: "Open-Meteo grid of 35 points over the map extent; otherwise the forecast wind at the place.",
  ...
  de: {
    ...
    sourceGroupNowcastDetails: "15-Minuten-Zeitachse aus der Vorhersage. Im DWD-Gebiet stammen die Regenwerte aus DWD MOSMIX, die Regenmenge der nächsten Stunde und die aktuelle Stärke (Menüleiste) aus dem DWD-Radar über Bright Sky.",
    sourceGroupRadar: "Radar",
    ...
    sourceGroupWindDetails: "Open-Meteo-Gitter mit 35 Punkten über dem Kartenausschnitt; sonst der Vorhersagewind am Ort.",
...
addCatalogEntries("es", {
  ...
  "sourceGroupNowcastDetails": "Eje de tiempo de 15 minutos del pronóstico. En la zona del DWD los valores de lluvia proceden de DWD MOSMIX, y la lluvia de la próxima hora y la intensidad actual (barra de menú), del radar del DWD vía Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Cuadrícula de Open-Meteo de 35 puntos sobre el área del mapa; si no, el viento pronosticado en el lugar.",
...
addCatalogEntries("fr", {
  ...
  "sourceGroupNowcastDetails": "Axe temporel de 15 minutes issu des prévisions. Dans la zone DWD, les valeurs de pluie viennent de DWD MOSMIX, et la pluie de l’heure suivante ainsi que l’intensité actuelle (barre de menus) du radar DWD via Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Grille Open-Meteo de 35 points sur l’étendue de la carte ; sinon le vent prévu au lieu.",
...
addCatalogEntries("pt", {
  ...
  "sourceGroupNowcastDetails": "Eixo de tempo de 15 minutos da previsão. Na área do DWD os valores de chuva vêm do DWD MOSMIX, e a chuva da próxima hora e a intensidade atual (barra de menu) do radar do DWD via Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Grade do Open-Meteo com 35 pontos sobre a área do mapa; caso contrário, o vento previsto no local.",
...
addCatalogEntries("ru", {
  ...
  "sourceGroupNowcastDetails": "Шкала времени с шагом 15 минут из прогноза. В зоне DWD значения осадков берутся из DWD MOSMIX, а осадки на ближайший час и текущая интенсивность (строка меню) — с радара DWD через Bright Sky.",
  ...
  "sourceGroupWindDetails": "Сетка Open-Meteo из 35 точек на области карты; иначе прогнозируемый ветер в месте.",
...
addCatalogEntries("uk", {
  ...
  "sourceGroupNowcastDetails": "Шкала часу з кроком 15 хвилин із прогнозу. У зоні DWD значення опадів беруться з DWD MOSMIX, а опади на найближчу годину й поточна інтенсивність (панель меню) — з радара DWD через Bright Sky.",
  "sourceGroupRadar": "Радар",
  ...
  "sourceGroupWindDetails": "Сітка Open-Meteo з 35 точок на області мапи; інакше прогнозований вітер у місці.",
...
addCatalogEntries("pl", {
  ...
  "sourceGroupNowcastDetails": "15-minutowa oś czasu z prognozy. W obszarze DWD wartości opadów pochodzą z DWD MOSMIX, a opad w najbliższej godzinie i bieżące natężenie (pasek menu) z radaru DWD przez Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Siatka Open-Meteo z 35 punktów na obszarze mapy; w przeciwnym razie prognozowany wiatr w miejscu.",
...
addCatalogEntries("it", {
  ...
  "sourceGroupNowcastDetails": "Asse temporale di 15 minuti dalle previsioni. Nell’area DWD i valori di pioggia vengono da DWD MOSMIX, la pioggia della prossima ora e l’intensità attuale (barra dei menu) dal radar DWD tramite Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Griglia Open-Meteo di 35 punti sull’area della mappa; altrimenti il vento previsto nel luogo.",
...
addCatalogEntries("nl", {
  ...
  "sourceGroupNowcastDetails": "Tijdas van 15 minuten uit de verwachting. In het DWD-gebied komen de regenwaarden uit DWD MOSMIX, en de regen van het komende uur en de huidige intensiteit (menubalk) uit de DWD-radar via Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Open-Meteo-raster van 35 punten over het kaartgebied; anders de verwachte wind op de plaats.",
...
addCatalogEntries("tr", {
  ...
  "sourceGroupNowcastDetails": "Tahminden 15 dakikalık zaman ekseni. DWD bölgesinde yağış değerleri DWD MOSMIX'ten, önümüzdeki saatin yağışı ve güncel şiddet (menü çubuğu) ise Bright Sky üzerinden DWD radarından gelir.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Harita alanı üzerinde 35 noktalı Open-Meteo ızgarası; aksi hâlde yerdeki tahmini rüzgâr.",
...
addCatalogEntries("cs", {
  ...
  "sourceGroupNowcastDetails": "Časová osa po 15 minutách z předpovědi. V oblasti DWD pocházejí srážkové hodnoty z DWD MOSMIX, srážky v příští hodině a aktuální intenzita (panel nabídky) z radaru DWD přes Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Síť Open-Meteo s 35 body přes výřez mapy; jinak předpovídaný vítr v místě.",
...
addCatalogEntries("sv", {
  ...
  "sourceGroupNowcastDetails": "Tidsaxel på 15 minuter från prognosen. I DWD-området kommer regnvärdena från DWD MOSMIX, och regnet närmaste timmen samt aktuell intensitet (menyraden) från DWD-radarn via Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Open-Meteo-rutnät med 35 punkter över kartans yta; annars prognosvinden på platsen.",
...
addCatalogEntries("fi", {
  ...
  "sourceGroupNowcastDetails": "Ennusteen 15 minuutin aika-akseli. DWD-alueella sadearvot tulevat DWD MOSMIXista, seuraavan tunnin sade ja nykyinen voimakkuus (valikkorivi) DWD-tutkasta Bright Skyn kautta.",
  ...
  "sourceGroupWindDetails": "Open-Meteon 35 pisteen ruudukko kartan alueella; muuten paikan ennustettu tuuli.",
...
addCatalogEntries("nb", {
  ...
  "sourceGroupNowcastDetails": "Tidsakse på 15 minutter fra varselet. I DWD-området kommer regnverdiene fra DWD MOSMIX, og regnet neste time og nåværende intensitet (menylinjen) fra DWD-radaren via Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Open-Meteo-rutenett med 35 punkter over kartutsnittet; ellers varslet vind på stedet.",
...
addCatalogEntries("da", {
  ...
  "sourceGroupNowcastDetails": "Tidsakse på 15 minutter fra prognosen. I DWD-området kommer regnværdierne fra DWD MOSMIX, og regnen i den næste time samt den aktuelle intensitet (menulinjen) fra DWD-radaren via Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Open-Meteo-gitter med 35 punkter over kortudsnittet; ellers prognosevinden på stedet.",
...
addCatalogEntries("ro", {
  ...
  "sourceGroupNowcastDetails": "Axă de timp de 15 minute din prognoză. În zona DWD valorile de ploaie vin de la DWD MOSMIX, iar ploaia din ora următoare și intensitatea actuală (bara de meniu) de la radarul DWD prin Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Grilă Open-Meteo de 35 de puncte peste zona hărții; altfel vântul prognozat în loc.",
...
addCatalogEntries("hu", {
  ...
  "sourceGroupNowcastDetails": "15 perces időtengely az előrejelzésből. A DWD-területen a csapadékértékek a DWD MOSMIX-ből, a következő óra csapadéka és az aktuális intenzitás (menüsáv) a DWD-radarból származik Bright Skyon keresztül.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "35 pontos Open-Meteo-rács a térkép területén; egyébként a hely előrejelzett szele.",
...
addCatalogEntries("el", {
  ...
  "sourceGroupNowcastDetails": "Άξονας χρόνου 15 λεπτών από την πρόγνωση. Στην περιοχή του DWD οι τιμές βροχής προέρχονται από το DWD MOSMIX, ενώ η βροχή της επόμενης ώρας και η τρέχουσα ένταση (γραμμή μενού) από το ραντάρ του DWD μέσω Bright Sky.",
  ...
  "sourceGroupWindDetails": "Πλέγμα Open-Meteo 35 σημείων στην έκταση του χάρτη· διαφορετικά ο προβλεπόμενος άνεμος στην τοποθεσία.",
...
addCatalogEntries("zh_CN", {
  ...
  "sourceGroupNowcastDetails": "预报中的 15 分钟时间轴。在 DWD 区域内，降雨值来自 DWD MOSMIX，未来一小时降雨量和当前强度（菜单栏）来自经由 Bright Sky 的 DWD 雷达。",
  "sourceGroupRadar": "雷达",
  "sourceGroupRadarDetails": "雷达图像来自官方地区服务；在其他地区或其失效时由 RainViewer 接替。没有任何雷达时，地图显示模式降水。",
  "sourceGroupWind": "风场地图",
  "sourceGroupWindDetails": "覆盖地图范围的 35 点 Open-Meteo 网格；否则使用该地点的预报风。",
...
addCatalogEntries("zh_TW", {
  ...
  "sourceGroupNowcastDetails": "預報中的 15 分鐘時間軸。在 DWD 區域內，降雨值來自 DWD MOSMIX，未來一小時雨量與目前強度（選單列）則來自經由 Bright Sky 的 DWD 雷達。",
  "sourceGroupRadar": "雷達",
  "sourceGroupRadarDetails": "雷達影像來自官方區域服務；在其他地區或服務失效時由 RainViewer 接手。完全沒有雷達時，地圖顯示模式降水。",
  "sourceGroupWind": "風場地圖",
  "sourceGroupWindDetails": "涵蓋地圖範圍的 35 點 Open-Meteo 網格；否則使用該地點的預報風。",
...
addCatalogEntries("ja", {
  ...
  "sourceGroupNowcastDetails": "予報の15分刻みの時間軸。DWD 領域では雨の値は DWD MOSMIX から、次の1時間の降水量と現在の強さ（メニューバー）は Bright Sky 経由の DWD レーダーから取得します。",
  ...
  "sourceGroupWindDetails": "地図範囲をカバーする 35 地点の Open-Meteo グリッド。なければその場所の予報風。",
...
addCatalogEntries("ko", {
  ...
  "sourceGroupNowcastDetails": "예보의 15분 간격 시간축. DWD 영역에서는 강수 값을 DWD MOSMIX에서, 다음 1시간 강수량과 현재 강도(메뉴 막대)는 Bright Sky를 거친 DWD 레이더에서 가져옵니다.",
  ...
  "sourceGroupWindDetails": "지도 범위를 덮는 35개 지점의 Open-Meteo 격자. 없으면 해당 장소의 예보 바람.",
...
addCatalogEntries("ar", {
  ...
  "sourceGroupNowcastDetails": "محور زمني كل 15 دقيقة من التوقعات. في منطقة DWD تأتي قيم المطر من DWD MOSMIX، وكمية مطر الساعة القادمة والشدة الحالية (شريط القوائم) من رادار DWD عبر Bright Sky.",
  ...
  "sourceGroupWindDetails": "شبكة Open-Meteo من 35 نقطة فوق نطاق الخريطة؛ وإلا فالرياح المتوقعة في المكان.",
...
addCatalogEntries("he", {
  ...
  "sourceGroupNowcastDetails": "ציר זמן של 15 דקות מהתחזית. באזור DWD ערכי הגשם מגיעים מ-DWD MOSMIX, וכמות הגשם בשעה הקרובה והעוצמה הנוכחית (שורת התפריטים) ממכ״ם DWD דרך Bright Sky.",
  ...
  "sourceGroupWindDetails": "רשת Open-Meteo של 35 נקודות על פני שטח המפה; אחרת הרוח החזויה במקום.",
...
addCatalogEntries("fa", {
  ...
  "sourceGroupNowcastDetails": "محور زمانی 15 دقیقه‌ای از پیش‌بینی. در محدودهٔ DWD مقادیر باران از DWD MOSMIX و بارش ساعت آینده و شدت کنونی (نوار منو) از رادار DWD از طریق Bright Sky می‌آید.",
  ...
  "sourceGroupWindDetails": "شبکهٔ 35 نقطه‌ای Open-Meteo روی گسترهٔ نقشه؛ در غیر این صورت باد پیش‌بینی‌شده در مکان.",
...
addCatalogEntries("hi", {
  ...
  "sourceGroupNowcastDetails": "पूर्वानुमान से 15 मिनट की समय-रेखा। DWD क्षेत्र में बारिश के मान DWD MOSMIX से आते हैं, और अगले घंटे की बारिश व वर्तमान तीव्रता (मेन्यू बार) Bright Sky के ज़रिए DWD रडार से।",
  ...
  "sourceGroupWindDetails": "मानचित्र क्षेत्र पर 35 बिंदुओं का Open-Meteo ग्रिड; अन्यथा स्थान पर पूर्वानुमानित हवा।",
...
addCatalogEntries("id", {
  ...
  "sourceGroupNowcastDetails": "Sumbu waktu 15 menit dari prakiraan. Di wilayah DWD nilai hujan berasal dari DWD MOSMIX, sedangkan hujan satu jam ke depan dan intensitas saat ini (bilah menu) dari radar DWD melalui Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Kisi Open-Meteo 35 titik di atas area peta; jika tidak, angin prakiraan di tempat itu.",
...
addCatalogEntries("vi", {
  ...
  "sourceGroupNowcastDetails": "Trục thời gian 15 phút từ dự báo. Trong vùng DWD, giá trị mưa lấy từ DWD MOSMIX, còn lượng mưa giờ tới và cường độ hiện tại (thanh menu) lấy từ radar DWD qua Bright Sky.",
  "sourceGroupRadar": "Radar",
  ...
  "sourceGroupWindDetails": "Lưới Open-Meteo gồm 35 điểm trên phạm vi bản đồ; nếu không thì gió dự báo tại địa điểm.",
...
addCatalogEntries("th", {
  ...
  "sourceGroupNowcastDetails": "แกนเวลาทุก 15 นาทีจากพยากรณ์ ในพื้นที่ DWD ค่าฝนมาจาก DWD MOSMIX ส่วนปริมาณฝนชั่วโมงถัดไปและความแรงปัจจุบัน (แถบเมนู) มาจากเรดาร์ DWD ผ่าน Bright Sky",
  ...
  "sourceGroupWindDetails": "กริด Open-Meteo 35 จุดครอบคลุมพื้นที่แผนที่ มิฉะนั้นใช้ลมพยากรณ์ ณ สถานที่",
