...
var catalog = {
  en: {
    ...
    sourceGroupNowcastDetails: "15-minute time axis from the forecast. In the DWD area the rain amounts and the rain start come from the DWD radar nowcast via Bright Sky, averaged over 3 × 3 km: rain that is already falling, moved along its track. The probability, and the amounts beyond the radar's two hours, come from DWD MOSMIX; the radar cannot foresee showers that have yet to form. Elsewhere all values come from the forecast.",
  ...
  de: {
    ...
    sourceGroupNowcastDetails: "15-Minuten-Zeitachse aus der Vorhersage. Im DWD-Gebiet stammen Regenmengen und Regenbeginn aus dem DWD-Radar-Nowcast über Bright Sky, gemittelt über 3 × 3 km: Regen, der bereits fällt, entlang seiner Zugbahn weitergerechnet. Die Wahrscheinlichkeit und die Mengen jenseits der zwei Radarstunden stammen aus DWD MOSMIX; Schauer, die erst noch entstehen, kann das Radar nicht vorhersehen. Anderswo stammen alle Werte aus der Vorhersage.",
    sourceGroupRadar: "Radar",
...
addCatalogEntries("es", {
  ...
  "sourceGroupNowcastDetails": "Eje de tiempo de 15 minutos del pronóstico. En la zona del DWD las cantidades de lluvia y el inicio de la lluvia proceden del nowcast del radar del DWD vía Bright Sky, promediados sobre 3 × 3 km: lluvia que ya cae, desplazada a lo largo de su trayectoria. La probabilidad, y las cantidades más allá de las dos horas del radar, proceden de DWD MOSMIX; el radar no puede prever chubascos que aún no se han formado. En el resto, todos los valores proceden del pronóstico.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("fr", {
  ...
  "sourceGroupNowcastDetails": "Axe temporel de 15 minutes issu des prévisions. Dans la zone DWD, les cumuls et le début de la pluie viennent de la prévision immédiate du radar DWD via Bright Sky, moyennés sur 3 × 3 km : la pluie qui tombe déjà, déplacée le long de sa trajectoire. La probabilité, et les cumuls au-delà des deux heures du radar, viennent de DWD MOSMIX ; le radar ne peut pas prévoir les averses qui ne se sont pas encore formées. Ailleurs, toutes les valeurs viennent des prévisions.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("pt", {
  ...
  "sourceGroupNowcastDetails": "Eixo de tempo de 15 minutos da previsão. Na área do DWD os volumes e o início da chuva vêm do nowcast do radar do DWD via Bright Sky, com média sobre 3 × 3 km: chuva que já está caindo, deslocada ao longo de sua trajetória. A probabilidade, e os volumes além das duas horas do radar, vêm do DWD MOSMIX; o radar não consegue prever pancadas que ainda não se formaram. No resto, todos os valores vêm da previsão.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("ru", {
  ...
  "sourceGroupNowcastDetails": "Шкала времени с шагом 15 минут из прогноза. В зоне DWD количество осадков и время их начала берутся из наукаста радара DWD через Bright Sky, усреднённого по площади 3 × 3 км: уже выпадающие осадки, смещённые по их траектории. Вероятность и количество за пределами двух радарных часов берутся из DWD MOSMIX; ливни, которые ещё не сформировались, радар предвидеть не может. В других местах все значения берутся из прогноза.",
...
addCatalogEntries("uk", {
  ...
  "sourceGroupNowcastDetails": "Шкала часу з кроком 15 хвилин із прогнозу. У зоні DWD кількість опадів і час їх початку беруться з наукасту радара DWD через Bright Sky, усередненого за площею 3 × 3 км: опади, що вже випадають, зміщені вздовж їхньої траєкторії. Імовірність і кількість поза двома радарними годинами беруться з DWD MOSMIX; зливи, які ще не сформувалися, радар передбачити не може. Деінде всі значення беруться з прогнозу.",
  "sourceGroupRadar": "Радар",
...
addCatalogEntries("pl", {
  ...
  "sourceGroupNowcastDetails": "15-minutowa oś czasu z prognozy. W obszarze DWD ilość opadów i początek deszczu pochodzą z nowcastu radaru DWD przez Bright Sky, uśrednionego na obszarze 3 × 3 km: deszcz, który już pada, przesunięty wzdłuż swojej trasy. Prawdopodobieństwo oraz ilości poza dwiema godzinami radaru pochodzą z DWD MOSMIX; radar nie przewidzi przelotnych opadów, które dopiero się utworzą. Gdzie indziej wszystkie wartości pochodzą z prognozy.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("it", {
  ...
  "sourceGroupNowcastDetails": "Asse temporale di 15 minuti dalle previsioni. Nell’area DWD le quantità e l’inizio della pioggia vengono dal nowcast del radar DWD tramite Bright Sky, mediato su 3 × 3 km: pioggia che sta già cadendo, spostata lungo la sua traiettoria. La probabilità, e le quantità oltre le due ore del radar, vengono da DWD MOSMIX; il radar non può prevedere rovesci che devono ancora formarsi. Altrove tutti i valori vengono dalle previsioni.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("nl", {
  ...
  "sourceGroupNowcastDetails": "Tijdas van 15 minuten uit de verwachting. In het DWD-gebied komen de regenhoeveelheden en het begin van de regen uit de nowcast van de DWD-radar via Bright Sky, gemiddeld over 3 × 3 km: regen die al valt, verplaatst langs zijn baan. De kans, en de hoeveelheden na de twee radaruren, komen uit DWD MOSMIX; buien die nog moeten ontstaan kan de radar niet voorzien. Elders komen alle waarden uit de verwachting.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("tr", {
  ...
  "sourceGroupNowcastDetails": "Tahminden 15 dakikalık zaman ekseni. DWD bölgesinde yağış miktarları ve yağışın başlangıcı, Bright Sky üzerinden DWD radar anlık tahmininden gelir ve 3 × 3 km üzerinden ortalaması alınır: hâlihazırda düşen yağış, izlediği yol boyunca ilerletilir. Olasılık ve radarın iki saatinin ötesindeki miktarlar DWD MOSMIX'ten gelir; radar henüz oluşmamış sağanakları öngöremez. Diğer yerlerde tüm değerler tahminden gelir.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("cs", {
  ...
  "sourceGroupNowcastDetails": "Časová osa po 15 minutách z předpovědi. V oblasti DWD pocházejí úhrny a začátek deště z nowcastu radaru DWD přes Bright Sky, zprůměrovaného na ploše 3 × 3 km: déšť, který už padá, posunutý podél své dráhy. Pravděpodobnost a úhrny za dvěma hodinami radaru pocházejí z DWD MOSMIX; přeháňky, které teprve vzniknou, radar předvídat nedokáže. Jinde pocházejí všechny hodnoty z předpovědi.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("sv", {
  ...
  "sourceGroupNowcastDetails": "Tidsaxel på 15 minuter från prognosen. I DWD-området kommer regnmängderna och när regnet börjar från DWD-radarns nowcast via Bright Sky, medelvärde över 3 × 3 km: regn som redan faller, förflyttat längs sin bana. Sannolikheten, och mängderna efter radarns två timmar, kommer från DWD MOSMIX; skurar som ännu inte har bildats kan radarn inte förutse. Annars kommer alla värden från prognosen.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("fi", {
  ...
  "sourceGroupNowcastDetails": "Ennusteen 15 minuutin aika-akseli. DWD-alueella sademäärät ja sateen alkaminen tulevat DWD-tutkan nowcastista Bright Skyn kautta, keskiarvona 3 × 3 km:n alueelta: jo satava sade siirrettynä kulkureittiään pitkin. Todennäköisyys ja tutkan kahden tunnin jälkeiset määrät tulevat DWD MOSMIXista; tutka ei voi ennakoida kuuroja, jotka eivät ole vielä syntyneet. Muualla kaikki arvot tulevat ennusteesta.",
...
addCatalogEntries("nb", {
  ...
  "sourceGroupNowcastDetails": "Tidsakse på 15 minutter fra varselet. I DWD-området kommer regnmengdene og når regnet begynner fra DWD-radarens nowcast via Bright Sky, som gjennomsnitt over 3 × 3 km: regn som allerede faller, flyttet langs banen sin. Sannsynligheten, og mengdene etter radarens to timer, kommer fra DWD MOSMIX; byger som ennå ikke har dannet seg, kan radaren ikke forutse. Ellers kommer alle verdier fra varselet.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("da", {
  ...
  "sourceGroupNowcastDetails": "Tidsakse på 15 minutter fra prognosen. I DWD-området kommer regnmængderne og regnens start fra DWD-radarens nowcast via Bright Sky, som gennemsnit over 3 × 3 km: regn, der allerede falder, flyttet langs sin bane. Sandsynligheden, og mængderne efter radarens to timer, kommer fra DWD MOSMIX; byger, der endnu ikke er dannet, kan radaren ikke forudse. Andre steder kommer alle værdier fra prognosen.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("ro", {
  ...
  "sourceGroupNowcastDetails": "Axă de timp de 15 minute din prognoză. În zona DWD cantitățile și începutul ploii vin din nowcastul radarului DWD prin Bright Sky, mediat pe 3 × 3 km: ploaia care deja cade, deplasată pe traiectoria ei. Probabilitatea, și cantitățile de după cele două ore ale radarului, vin de la DWD MOSMIX; radarul nu poate prevedea aversele care încă nu s-au format. În rest, toate valorile vin din prognoză.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("hu", {
  ...
  "sourceGroupNowcastDetails": "15 perces időtengely az előrejelzésből. A DWD-területen a csapadékmennyiség és az eső kezdete a DWD-radar Bright Skyon keresztül kapott nowcastjából származik, 3 × 3 km-re átlagolva: a már hulló csapadék a pályája mentén továbbléptetve. A valószínűség és a radar két óráján túli mennyiségek a DWD MOSMIX-ből származnak; a még ki sem alakult záporokat a radar nem láthatja előre. Máshol minden érték az előrejelzésből származik.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("el", {
  ...
  "sourceGroupNowcastDetails": "Άξονας χρόνου 15 λεπτών από την πρόγνωση. Στην περιοχή του DWD οι ποσότητες και η έναρξη της βροχής προέρχονται από την άμεση πρόγνωση του ραντάρ του DWD μέσω Bright Sky, με μέσο όρο σε 3 × 3 km: βροχή που ήδη πέφτει, μετατοπισμένη κατά μήκος της πορείας της. Η πιθανότητα, και οι ποσότητες πέρα από τις δύο ώρες του ραντάρ, προέρχονται από το DWD MOSMIX· μπόρες που δεν έχουν ακόμη σχηματιστεί δεν μπορεί να τις προβλέψει το ραντάρ. Αλλού όλες οι τιμές προέρχονται από την πρόγνωση.",
...
addCatalogEntries("zh_CN", {
  ...
  "sourceGroupNowcastDetails": "预报中的 15 分钟时间轴。在 DWD 区域内，降雨量和开始下雨的时间来自经由 Bright Sky 的 DWD 雷达临近预报，取 3 × 3 公里范围的平均值：正在下的雨沿其移动路径向前推算。降雨概率以及雷达两小时之后的降雨量来自 DWD MOSMIX；尚未形成的阵雨，雷达无法预见。其他地区所有数值均来自预报。",
  "sourceGroupRadar": "雷达",
...
addCatalogEntries("zh_TW", {
  ...
  "sourceGroupNowcastDetails": "預報中的 15 分鐘時間軸。在 DWD 區域內，雨量與開始下雨的時間來自經由 Bright Sky 的 DWD 雷達即時預報，取 3 × 3 公里範圍的平均值：正在下的雨沿其移動路徑向前推算。降雨機率以及雷達兩小時之後的雨量來自 DWD MOSMIX；尚未形成的陣雨，雷達無法預見。其他地區所有數值均來自預報。",
  "sourceGroupRadar": "雷達",
...
addCatalogEntries("ja", {
  ...
  "sourceGroupNowcastDetails": "予報の15分刻みの時間軸。DWD 領域では、降水量と雨の降り始めは Bright Sky 経由の DWD レーダーのナウキャストから取得し、3 × 3 km の平均をとります。すでに降っている雨を、その進路に沿って進めたものです。降水確率と、レーダーの2時間より先の降水量は DWD MOSMIX から取得します。まだ発生していないにわか雨はレーダーでは予測できません。その他の地域ではすべての値が予報から取得されます。",
...
addCatalogEntries("ko", {
  ...
  "sourceGroupNowcastDetails": "예보의 15분 간격 시간축. DWD 영역에서는 강수량과 비 시작 시각을 Bright Sky를 거친 DWD 레이더 초단기 예측에서 3 × 3km 평균으로 가져옵니다. 이미 내리고 있는 비를 이동 경로를 따라 옮긴 값입니다. 강수 확률과 레이더 2시간 이후의 강수량은 DWD MOSMIX에서 가져오며, 아직 생기지 않은 소나기는 레이더가 예측할 수 없습니다. 그 밖의 지역에서는 모든 값을 예보에서 가져옵니다.",
...
addCatalogEntries("ar", {
  ...
  "sourceGroupNowcastDetails": "محور زمني كل 15 دقيقة من التوقعات. في منطقة DWD تأتي كميات المطر وبدايته من التنبؤ الآني لرادار DWD عبر Bright Sky، بمتوسط على مساحة 3 × 3 كم: مطر يهطل بالفعل، مُحرَّك على امتداد مساره. أما الاحتمال والكميات بعد ساعتي الرادار فتأتي من DWD MOSMIX؛ ولا يستطيع الرادار توقع الزخات التي لم تتكون بعد. وفي غير ذلك تأتي كل القيم من التوقعات.",
...
addCatalogEntries("he", {
  ...
  "sourceGroupNowcastDetails": "ציר זמן של 15 דקות מהתחזית. באזור DWD כמויות הגשם ותחילתו מגיעות מתחזית המיידית של מכ״ם DWD דרך Bright Sky, בממוצע על פני 3 × 3 ק״מ: גשם שכבר יורד, מוזז לאורך מסלולו. ההסתברות, והכמויות שאחרי שתי שעות המכ״ם, מגיעות מ-DWD MOSMIX; ממטרים שטרם נוצרו המכ״ם אינו יכול לחזות. במקומות אחרים כל הערכים מגיעים מהתחזית.",
...
addCatalogEntries("fa", {
  ...
  "sourceGroupNowcastDetails": "محور زمانی 15 دقیقه‌ای از پیش‌بینی. در محدودهٔ DWD مقدار باران و زمان شروع آن از پیش‌بینی کوتاه‌مدت رادار DWD از طریق Bright Sky می‌آید که روی 3 × 3 کیلومتر میانگین گرفته می‌شود: بارانی که هم‌اکنون می‌بارد، در امتداد مسیرش جابه‌جا شده. احتمال بارش و مقادیرِ پس از دو ساعتِ رادار از DWD MOSMIX می‌آید؛ رگبارهایی را که هنوز شکل نگرفته‌اند رادار نمی‌تواند پیش‌بینی کند. در جاهای دیگر همهٔ مقادیر از پیش‌بینی می‌آید.",
...
addCatalogEntries("hi", {
  ...
  "sourceGroupNowcastDetails": "पूर्वानुमान से 15 मिनट की समय-रेखा। DWD क्षेत्र में बारिश की मात्रा और बारिश शुरू होने का समय Bright Sky के ज़रिए DWD रडार नाउकास्ट से आता है, 3 × 3 किमी के औसत के रूप में: पहले से हो रही बारिश, उसके मार्ग पर आगे बढ़ाई गई। संभावना, और रडार के दो घंटों के बाद की मात्रा, DWD MOSMIX से आती है; जो बौछारें अभी बनी ही नहीं हैं, उन्हें रडार पहले से नहीं देख सकता। अन्य जगहों पर सभी मान पूर्वानुमान से आते हैं।",
...
addCatalogEntries("id", {
  ...
  "sourceGroupNowcastDetails": "Sumbu waktu 15 menit dari prakiraan. Di wilayah DWD jumlah hujan dan waktu mulainya hujan berasal dari nowcast radar DWD melalui Bright Sky, dirata-ratakan pada 3 × 3 km: hujan yang sudah turun, digeser mengikuti lintasannya. Peluang hujan, dan jumlah setelah dua jam radar, berasal dari DWD MOSMIX; hujan lokal yang belum terbentuk tidak dapat diperkirakan radar. Di tempat lain semua nilai berasal dari prakiraan.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("vi", {
  ...
  "sourceGroupNowcastDetails": "Trục thời gian 15 phút từ dự báo. Trong vùng DWD, lượng mưa và thời điểm bắt đầu mưa lấy từ dự báo tức thời của radar DWD qua Bright Sky, lấy trung bình trên 3 × 3 km: mưa đang rơi, được dịch chuyển theo đường đi của nó. Xác suất mưa, và lượng mưa sau hai giờ của radar, lấy từ DWD MOSMIX; radar không thể thấy trước những cơn mưa rào chưa hình thành. Ở nơi khác, mọi giá trị đều lấy từ dự báo.",
  "sourceGroupRadar": "Radar",
...
addCatalogEntries("th", {
  ...
  "sourceGroupNowcastDetails": "แกนเวลาทุก 15 นาทีจากพยากรณ์ ในพื้นที่ DWD ปริมาณฝนและเวลาที่ฝนเริ่มตกมาจากการพยากรณ์ระยะสั้นของเรดาร์ DWD ผ่าน Bright Sky โดยเฉลี่ยบนพื้นที่ 3 × 3 กม. คือฝนที่กำลังตกอยู่แล้วซึ่งถูกเลื่อนไปตามเส้นทางการเคลื่อนตัว ส่วนโอกาสเกิดฝนและปริมาณฝนหลังสองชั่วโมงของเรดาร์มาจาก DWD MOSMIX เรดาร์ไม่สามารถคาดการณ์ฝนที่ยังไม่ก่อตัว ที่อื่นค่าทั้งหมดมาจากพยากรณ์",
